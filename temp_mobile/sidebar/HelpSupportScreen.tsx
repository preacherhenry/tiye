...
const HelpSupportScreen = ({ navigation }: any) => {
    ...
    const faqs = [
        { id: 1, q: 'How do I cancel a ride?', a: 'You can cancel a ride before it starts by tapping the "Cancel" button on the trip island. Note that cancellation fees may apply.' },
