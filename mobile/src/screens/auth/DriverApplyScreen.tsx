...
import {
    ...
    Alert, Image, ActivityIndicator, Dimensions, KeyboardAvoidingView, Platform
} from 'react-native';
            ...
            <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
                ...
                {step === 4 && (
                    <View style={styles.stepContainer}>
                        ...
                        <DocPicker label="Driver's License (Front)" uri={docs.license_front} onPick={() => pickImage('license_front')} />
                        <DocPicker label="Driver's License (Back)" uri={docs.license_back} onPick={() => pickImage('license_back')} />
